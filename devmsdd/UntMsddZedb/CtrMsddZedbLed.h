...
#ifndef CTRMSDDZEDBLED_H
#define CTRMSDDZEDBLED_H

#include "Msdd.h"

#define VecVMsddZedbLedCommand CtrMsddZedbLed::VecVCommand

/**
	* CtrMsddZedbLed
	*/
class CtrMsddZedbLed : public CtrMsdd {

public:
	/**
		* VecVCommand (full: VecVMsddZedbLedCommand)
		*/
	class VecVCommand {
